...
STM32L073Z-EVAL's LED can be used to monitor the application status:
  - LED1 is  toggling when the application runs successfully.
...
@par Directory contents
  ...
  - FatFs/FatFs_uSD_Standalone/Inc/stm32l0xx_hal_conf.h    HAL configuration file
  - FatFs/FatFs_uSD_Standalone/Inc/stm32l0xx_it.h          Interrupt handlers header file
  ...
  - FatFs/FatFs_uSD_Standalone/Src/stm32l0xx_it.c          Interrupt handlers
  - FatFs/FatFs_uSD_Standalone/Src/main.c                  Main program
  - FatFs/FatFs_uSD_Standalone/Src/sd_diskio.c             FatFs uSD diskio driver
  - FatFs/FatFs_uSD_Standalone/Src/system_stm32l0xx.c      STM32L0xx system source file

@par Hardware and Software environment

  - This application runs on STM32L073xx devices

  - This application has been tested with STM32L073Z-EVAL board and can be
